    ...
    if (!$name || !$email || !$phone || !$password || !$classLevel) {
        ...
        if ($exists) {
            ...
            if (mysqli_stmt_execute($stmt)) {
                ...
                redirect(SITE_URL . '/student/dashboard.php?welcome=1');
            } else {
...
<div class="auth-page student-auth-page" style="align-items:flex-start;padding-top:40px;">
    ...
    <div class="auth-card animate-on-scroll" style="max-width:620px;">
            ...
            <form id="registerForm" method="POST" novalidate>
                ...
                <div class="form-group">
                    ...
                    <input type="email" name="email" class="form-control"
                           placeholder="email@example.com (used for login)" required
